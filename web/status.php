<?php
    ...
    // generate the modals
    generate_modal("upgrade_modal","The update will be downloaded and automatically installed.<br><br>The system will reboot to complete the process and install the update.<br>Please allow 3-5 minutes before reconnecting.","button","form");
                                                ...
                                                <dd>
                                                    <?php
                                                        if ($status["LAST_VERSION"] == "") {
                                                            ...
                                                            print '<button id="button" type="submit" class="btn btn-primary" onclick=\'$("#button").addClass("disabled"); $("#upgrade_modal").modal("show");return false;\'>';
